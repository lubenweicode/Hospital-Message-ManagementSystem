...
public class medicalRecordsServiceImpl implements medicalRecordsService {
    ...
    public Result getMedicalRecords(MedicalRecordDTO medicalRecordDTO) {
        ...
        List<MedicalRecord> medicalRecordList = medicalRecordsMapper.getMedicalRecord( medicalRecordDTO);
    ...
    public Result updateMedicalRecords(String medicalRecordId,MedicalRecordDTO medicalRecordDTO) {
        Result result = new Result();
        Integer flag = medicalRecordsMapper.updateMedicalRecord(medicalRecordId,medicalRecordDTO);
        if(flag != null){
            result.setCode(1);
    ...
    public Result getMedicalRecordById(String medicalRecordId) {
        Result result = new Result();
        MedicalRecord medicalRecord = medicalRecordsMapper.getMedicalRecordById(medicalRecordId);
